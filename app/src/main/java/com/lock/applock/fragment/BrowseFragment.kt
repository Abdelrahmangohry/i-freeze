...
class BrowseFragment(private var urlNew: String) : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        MainWebActivity.tabsList[MainWebActivity.myPager.currentItem].name = binding.webView.url.toString()
        ...
        binding.webView.apply {
            ...
            webViewClient = object: WebViewClient(){
                ...
                override fun doUpdateVisitedHistory(view: WebView?, url: String?, isReload: Boolean) {
                    ...
                    MainWebActivity.tabsList[MainWebActivity.myPager.currentItem].name = url.toString()
                }
                ...
                override fun onReceivedIcon(view: WebView?, icon: Bitmap?) {
                    ...
                    try{
                        ...
                        if(MainWebActivity.bookmarkIndex != -1){
                            ...
                            MainWebActivity.bookmarkList[MainWebActivity.bookmarkIndex].image = array.toByteArray()
                        }
                    }catch (e: Exception){}
                }
